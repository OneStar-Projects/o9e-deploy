...
insert into `users`(id, username, nickname, password, roles, create_at, create_by, update_at, update_by) values(1, 'admin', '超管', 'changeme', 'Admin', unix_timestamp(now()), 'system', unix_timestamp(now()), 'system');
